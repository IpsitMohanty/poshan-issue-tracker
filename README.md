...
- export filtered issue views to CSV
- add dashboard summaries by module, district, and severity
- add duplicate issue detection
- add optional API or Streamlit front end if the workflow grows beyond notebook use
